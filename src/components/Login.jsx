                ...
                <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                {
                  errors && <div className='alert'>
                    {Object.keys(errors).map(key => (
                      <p key={key} className="text-red-600">{errors[key][0]}</p>
                    ))}
                  </div>
                }
                    ...
                    <div>
                        ...
                        <div className="mt-2">
                        <input id="password" name="password" type="password" autoComplete="current-password" value={password} onChange={(e) => setPassword(e.target.value)}  className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                        </div>
                        {/* {errors?.password &&
